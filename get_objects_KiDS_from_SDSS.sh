...
do
  ...
  ${GETSDSS} STARS ${RAMIN} ${RAMAX} ${DECMIN} ${DECMAX} > catalog_${RAMIN}_${RAMAX}_${DECMIN}_${DECMAX}.csv
  sleep 1
done
...
ldacaddkey -i catalog.tmp9 -o ${FINALCAT}.cat -t STDTAB -k Epoch 2000.0 FLOAT "" n 0 SHORT "" m 0 SHORT "" A_WCS 0.0005 FLOAT "" \
